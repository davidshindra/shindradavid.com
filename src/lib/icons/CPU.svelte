<svg aria-labelledby="systemIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
  <title id="systemIcon">system</title>
